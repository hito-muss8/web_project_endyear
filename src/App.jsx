      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        >
          <div
            ...
            className="relative centre-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
          />
        </div>
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-65">
          <div className="hidden sm:mb-8 sm:flex sm:justify-centre">
          ...
          <div className="text-centre">
            ...
            <div className="mt-4 flex items-centre justify-centre gap-x-6">
              <a
                href="#"
